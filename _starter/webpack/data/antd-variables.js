// Оригинал из https://github.com/ant-design/ant-design/blob/master/components/style/themes/default.less

const { root } = require('../config/paths');

// import tailwind config
const tailwindConfig = require(root + '/tailwind.config');
...
module.exports = {
  ...
  '@font-size-base': fontSize.p1,
  // '@font-size-lg': '@font-size-base + 2px',
  '@font-size-sm': fontSize.p4,
  '@heading-1-size': fontSize.h1,
  '@heading-2-size': fontSize.h2,
  '@heading-3-size': fontSize.h3,
  '@heading-4-size': fontSize.h4,
  // https://github.com/ant-design/ant-design/issues/20210
  '@line-height-base': 1.2,
  '@border-radius-base': theme.borderRadius['2'],
  '@border-radius-btn': theme.borderRadius['20'],
  '@border-radius-sm': '@border-radius-base',

  // vertical paddings
  // '@padding-lg': '24px', // containers
  '@padding-md': '28px', // small containers and buttons
  ...
  '@link-hover-color': colors.orange,
  '@link-active-color': colors.orange,
  ...
  // Border color
  '@border-color-base': colors.pale_grey, // base border outline a component
  // '@border-color-split': hsv(0, 0, 94%), // split border inside a component
  '@border-color-inverse': colors.white,
  '@border-width-base': theme.borderWidth['2'], // width of the border for a component
  ...
  // Buttons
  '@btn-font-weight': 700,
  '@btn-border-radius-base': '@border-radius-btn',
  '@btn-border-radius-sm': '@border-radius-btn',
  ...
  '@btn-default-bg': '@success-color',
  '@btn-default-border': '@success-color',

  '@btn-danger-color': '@white',
  '@btn-danger-bg': '@warning-color',
  '@btn-danger-border': '@warning-color',
  ...
  // Small screen / mobile
  '@screen-sm': screens.sm.max,
  '@screen-sm-max': screens.sm.max,
  '@screen-sm-min': 0,

  // Medium screen / tablet
  '@screen-md': screens.md.max,
  '@screen-md-max': screens.md.max,
  '@screen-md-min': '@screen-sm-max + 1px',

  // Large screen / desktop
  '@screen-lg': screens.lg.max,
  '@screen-lg-max': screens.lg.max,
  '@screen-lg-min': '@screen-md-max + 1px',

  '@screen-xl': screens.xl.max,
  '@screen-xl-max': screens.xl.max,
  '@screen-xl-min': '@screen-lg-max + 1px',
  ...
  '@animation-duration-fast': '0.05s', // Tooltip

  //CollapsePanel
  '@collapse-panel-border-radius': 0, // '@border-radius-base',
  ...
  // Form
  // ---
  '@label-required-color': '@normal-color',
  '@label-color': '@normal-color',
  ...
  '@input-padding-horizontal-base': '0',
  ...
  // '@input-icon-hover-color': fade(colors.black, 85%)',
  ...
  '@select-item-selected-bg': colors.grey,
  ...
  '@select-selection-item-border-color': '@background-color-light',
  ...
  // '@menu-dark-submenu-bg': '#000'c17',
  // '@menu-dark-highlight-color': '#fff',
  // '@menu-dark-item-active-bg': '@primary-color',
  // '@menu-dark-selected-item-icon-color': colors.white',
  // '@menu-dark-selected-item-text-color': colors.white',
  ...
  '@back-top-hover-bg': '@warning-color',
  ...
  '@switch-min-width': '34px',
  // '@switch-sm-min-width': 28px',
  '@switch-sm-checked-margin-left': 0,
  '@switch-disabled-opacity': 1,
  '@switch-color': 'tint(@primary-color, 50%)',
  ...
  // '@pagination-item-disabled-color-active': colors.white',
  ...
  '@slider-handle-color-focus-shadow': 0,
  ...
  '@collapse-content-padding': '30px',
  '@collapse-content-bg': 'white', // '@component-background',
  ...
  // '@steps-nav-arrow-color': fade(colors.black, 25%)',
